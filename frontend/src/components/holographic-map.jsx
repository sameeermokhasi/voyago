    ...
    <group position={[-1.05, 0.95, 0.85]} scale={0.5}>
      <group ref={line1}>
        ...
        <Html position={[0, 1.15, 0]} center distanceFactor={6} zIndexRange={[10, 0]}>
          <div className="whitespace-nowrap rounded-full border border-yellow-400/40 bg-black/70 px-3 py-1 font-mono text-[11px] tracking-wider text-yellow-400 backdrop-blur">
            {origin} → {destination || '—'}
          </div>
        </Html>
